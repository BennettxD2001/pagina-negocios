            ...
            <Navbar fixed="top" collapseOnSelect expand="lg" variant="light"
                ...
                <Container >
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Navbar.Brand as={Link} to="/react-example/AdminLogin" title="Administracion"><h4 style={{ color:  "#000000" }} >Administrador</h4></Navbar.Brand>
                        <Container>
                        <Nav className="me-auto">
                            <NavDropdown title={<Navbar.Brand style={{ color:  "#000000", fontSize: 18 + "pt" }}>Perfil</Navbar.Brand>} id="nav-dropdown" >
                                ...
                                <NavDropdown.Item as={Link} to="/react-example/ShoppingCart" title="Carrito" style={{ color:  "#000000" }}><b>Carrito</b></NavDropdown.Item>
                                <NavDropdown.Item as={Link} to="/react-example/Favorites" title="Favoritos" style={{ color:  "#000000" }}><b>Favoritos</b></NavDropdown.Item>
                            </NavDropdown>
                        </Nav>
                        </Container>
                    </Navbar.Collapse>
